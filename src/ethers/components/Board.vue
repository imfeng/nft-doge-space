...
<template>
    <Modal v-bind:modalOpen="boardOpen" v-on:close="close">
        <div v-click-outside="close">
            <div
                v-on:click="connectWallet('metamask')"
                class="wallet-item"
                v-bind:class="metamaskDisabled && !appUrl ? 'wallet-disabled' : ''"
            >
                <div class="item">
            ...
            <div class="line"></div>
            <div
                v-on:click="connectWallet('walletconnect')"
                class="wallet-item"
                v-bind:class="walletconnectDisabled ? 'wallet-disabled' : ''"
            >
                <div class="item">
            ...
            <div class="line"></div>
            <div
                v-on:click="connectWallet('walletlink')"
                class="wallet-item"
                v-bind:class="walletlinkDisabled ? 'wallet-disabled' : ''"
            >
                <div class="item">
    ...
    <Modal v-bind:modalOpen="loadingOpen">
